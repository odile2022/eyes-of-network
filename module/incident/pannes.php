				...
				<div class="modal-content">
					<form method="post" action="controlleur.php?action=save_panne">
						<div class="modal-header">						
							...
							<h4 class="modal-title">Ajout Panne</h4>
						</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<form method="post" action="controlleur.php?action=edit_panne">
						<div class="modal-header">						
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title">Mise a jour de panne</h4>
						</div>
						<div class="modal-body">					
		...
		<div id="deleteEmployeeModal" class="modal fade">
			<div class="modal-dialog">
				...
				<form method="post" action="controlleur.php?action=delete_panne">
						<div class="modal-header">						
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title">Delete Panne</h4>
						</div>
						<div class="modal-body">					
...
<?php
$extraFooterTags = "<script> var dataSet =". json_encode(DB::panne()->tableData()).";".
<<<EOF
